...
MD5.prototype.b64_md5 = function (s) {
	return binl2b64(this.core_md5(this.str2binl(s), s.length * this.chrsz));
};
...
MD5.prototype.test = function () {
	console.log(this.hex_md5("abc") == "900150983cd24fb0d6963f7d28e17f72");
};
